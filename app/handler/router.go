...
func NewRouter(au usecase.Account, su usecase.Statuses, tu usecase.Timelines, ar repository.Account) http.Handler {
	r := chi.NewRouter()
	...
	r.Mount("/v1/statuses", statuses.NewRouter(su, ar))
